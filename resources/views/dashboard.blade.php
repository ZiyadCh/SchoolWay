...
<div class="min-h-screen flex flex-col space-y-10 pb-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex items-center gap-6 hover:border-amber-500/40 transition-all group shadow-lg">
            ...
            <div>
                ...
                <p class="text-5xl text-white mt-1">230</p>
            </div>
        </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex items-center gap-6 hover:border-amber-500/40 transition-all group shadow-lg">
            ...
            <div>
                ...
                <p class="text-5xl text-white mt-1">12</p>
            </div>
        </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex items-center gap-6 hover:border-amber-500/40 transition-all group shadow-lg">
            ...
            <div>
                ...
                <p class="text-5xl text-white mt-1">38</p>
            </div>
        </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex items-center gap-6 hover:border-amber-500/40 transition-all group shadow-lg">
            ...
            <div>
                ...
                <p class="text-5xl text-white mt-1">92%</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex flex-col h-full shadow-2xl">
            ...
            <div class="grow max-h-80 overflow-y-auto pr-2 mb-8 space-y-3 text-white">
                @foreach(['Maternelle', 'Primaire', 'Collège', 'Lycée'] as $n)
                    <div class="p-5 bg-gray-900 border border-gray-700 rounded-xl text-lg">{{ $n }}</div>
                @endforeach
            </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex flex-col h-full shadow-2xl">
            ...
            <div class="grow max-h-80 overflow-y-auto pr-2 mb-8 space-y-3  text-white">
                @foreach(['Mathématiques', 'Français', 'Anglais', 'Physique', 'SVT'] as $m)
                    <div class="p-5 bg-gray-900 border border-gray-700 rounded-xl text-lg">{{ $m }}</div>
                @endforeach
            </div>
            <button class="w-full py-4 bg-gray-700 hover:bg-amber-500 text-amber-500 hover:text-gray-900 text-sm uppercase rounded-xl transition-all border border-gray-600 font-bold">Gérer</button>
        </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 flex flex-col h-full shadow-2xl">
            ...
            <div class="grow max-h-80 overflow-y-auto pr-2 mb-8 space-y-3  text-white">
                @foreach(['Jean Dupont (6ème A)', 'Amina Alami (CP)', 'Lucas Martin (Terminale B)', 'Sara Benani (4ème C)'] as $abs)
                    <div class="p-5 bg-gray-900 border border-gray-700 rounded-xl text-lg border-l-4 border-l-red-500">
                        {{ $abs }}
                    </div>
                @endforeach
            </div>
