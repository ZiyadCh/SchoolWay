...
<div class="space-y-8 max-w-7xl mx-auto">
    ...
    <div class="bg-gray-900 border border-gray-800 p-4 rounded-4xl flex flex-col lg:flex-row gap-4">
        <div class="relative flex-1 group">
            ...
            <input type="text" placeholder="Rechercher un professeur par nom email..."
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-[3rem] overflow-hidden shadow-2xl">
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody id="teacher-table-body" class="divide-y divide-gray-800">
                </tbody>
            </table>
        </div>
    ...
    <tr class="hover:bg-gray-800-20 transition-colors group">
        ...
        <td class="px-8 py-6 text-right">
            <div class="flex justify-end gap-2">
                <a href="" class="teacher-link w-10 h-10 flex items-center justify-center rounded-xl bg-gray-800 text-gray-400 hover:text-white border border-gray-700 transition-all">
