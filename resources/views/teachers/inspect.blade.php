...
@section('content')
@vite(['resources/js/teacher/inspect.js'])
                ...
                <div class="flex-1 w-full">
                    <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 mb-10">
                        <div class="text-center lg:text-left">
                            ...
                            <p class="text-amber-500 font-medium tracking-[0.3em] text-[10px] uppercase mt-2 opacity-80">Corps Enseignant / Formateur</p>
                        </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-y-10 gap-x-6 border-t border-gray-800/60 pt-10">
                        ...
                        <div class="space-y-1.5">
                            <p class="text-[10px] text-gray-500 uppercase font-bold tracking-[0.15em]">Spécialité</p>
                            <p id="user-specialty" class="text-base font-semibold text-gray-100 uppercase"></p>
                        </div>
                        ...
                        <div class="space-y-1.5">
                            <p class="text-[10px] text-gray-500 uppercase font-bold tracking-[0.15em]">Bureau / Salle</p>
                            <p id="user-office" class="text-base font-semibold text-gray-100 uppercase"></p>
                        </div>
                        ...
                        <div class="col-span-2 space-y-1.5">
                            <p class="text-[10px] text-gray-500 uppercase font-bold tracking-[0.15em]">Email Professionnel</p>
                            <p id="user-email" class="text-base font-bold text-amber-500/90 truncate"></p>
                        </div>

                        <div class="col-span-2 space-y-1.5">
                            <p class="text-[10px] text-gray-500 uppercase font-bold tracking-[0.15em]">Date d'intégration</p>
