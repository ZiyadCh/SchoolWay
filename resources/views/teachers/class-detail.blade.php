...
<div id="absence-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/70 backdrop-blur-sm">
    <div class="bg-gray-900 border border-gray-800 rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-sm font-black uppercase tracking-widest text-white">Absences du jour</h3>
            <button class="close-modal text-gray-600 hover:text-white transition-colors text-xl leading-none">&times;</button>
        </div>
        <div class="space-y-4">
            <div>
            ...
            <div>
                <p class="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Élèves absents</p>
                <div id="absence-student-list" class="max-h-60 overflow-y-auto space-y-1 border border-gray-800 rounded-lg p-2"></div>
            </div>
